	...
	<div class="container">
		<div id="content">			
			<form action="{{ route('postCheckout') }}" method="post" class="beta-form-checkout">                
                @csrf
                <div class='row'>@if(Session::has('information')) {{Session::get('information')}} @endif </div>
				<div class="row">
					<div class="col-sm-6">
						<h4>Đặt hàng</h4>
					...
					<div class="col-sm-6">
						<div class="your-order">
							...
							<div class="text-center"><button class="beta-btn primary" href="#">Đặt hàng <i class="fa fa-chevron-right"></i></a></button></div>
						</div> <!-- .your-order -->
					</div>
				</div>
			</form>
