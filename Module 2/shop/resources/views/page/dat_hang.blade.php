							...
							<ul class="payment_methods methods">
								...
								<li class="payment_method_cheque">
									...
									<div class="payment_box payment_method_cheque" style="display: none;">
										...
										<a target="_blank" href="https://www.nganluong.vn/button_payment.php?receiver=duyit192@hotmail.com&product_name={{$cart['item']['name']}}&price=<?php echo "$tt";?>&return_url=ct14a1.890m.com&comments=Note"><img src="https://www.nganluong.vn/css/newhome/img/button/pay-lg.png"border="0" /></a> 
									</div>						
								</li>
							</ul>
						</div>
